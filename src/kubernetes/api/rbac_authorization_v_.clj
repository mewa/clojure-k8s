...
(defn delete-rbac-authorization-v1-cluster-role-with-http-info
  ...
  ([name body ] (delete-rbac-authorization-v1-cluster-role-with-http-info name body nil))
...
(defn delete-rbac-authorization-v1-cluster-role
  "
  delete a ClusterRole"
  ([name body ] (delete-rbac-authorization-v1-cluster-role name body nil))
  ([name body optional-params]
   (:data (delete-rbac-authorization-v1-cluster-role-with-http-info name body optional-params))))

(defn delete-rbac-authorization-v1-cluster-role-binding-with-http-info
  "
  delete a ClusterRoleBinding"
  ([name body ] (delete-rbac-authorization-v1-cluster-role-binding-with-http-info name body nil))
  ([name body {:keys [pretty grace-period-seconds orphan-dependents propagation-policy ]}]
   (check-required-params name body)
...
(defn delete-rbac-authorization-v1-cluster-role-binding
  "
  delete a ClusterRoleBinding"
  ([name body ] (delete-rbac-authorization-v1-cluster-role-binding name body nil))
  ([name body optional-params]
   (:data (delete-rbac-authorization-v1-cluster-role-binding-with-http-info name body optional-params))))
...
(defn delete-rbac-authorization-v1-namespaced-role-with-http-info
  "
  delete a Role"
  ([name namespace body ] (delete-rbac-authorization-v1-namespaced-role-with-http-info name namespace body nil))
...
(defn delete-rbac-authorization-v1-namespaced-role
  "
  delete a Role"
  ([name namespace body ] (delete-rbac-authorization-v1-namespaced-role name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-rbac-authorization-v1-namespaced-role-with-http-info name namespace body optional-params))))

(defn delete-rbac-authorization-v1-namespaced-role-binding-with-http-info
  "
  delete a RoleBinding"
  ([name namespace body ] (delete-rbac-authorization-v1-namespaced-role-binding-with-http-info name namespace body nil))
  ([name namespace body {:keys [pretty grace-period-seconds orphan-dependents propagation-policy ]}]
   (check-required-params name namespace body)
...
(defn delete-rbac-authorization-v1-namespaced-role-binding
  "
  delete a RoleBinding"
  ([name namespace body ] (delete-rbac-authorization-v1-namespaced-role-binding name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-rbac-authorization-v1-namespaced-role-binding-with-http-info name namespace body optional-params))))
