...
(defn delete-autoscaling-v1-namespaced-horizontal-pod-autoscaler-with-http-info
  ...
  ([name namespace body ] (delete-autoscaling-v1-namespaced-horizontal-pod-autoscaler-with-http-info name namespace body nil))
...
(defn delete-autoscaling-v1-namespaced-horizontal-pod-autoscaler
  "
  delete a HorizontalPodAutoscaler"
  ([name namespace body ] (delete-autoscaling-v1-namespaced-horizontal-pod-autoscaler name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-autoscaling-v1-namespaced-horizontal-pod-autoscaler-with-http-info name namespace body optional-params))))
