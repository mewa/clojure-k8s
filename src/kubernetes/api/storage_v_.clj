...
(defn delete-storage-v1-storage-class-with-http-info
  ...
  ([name body ] (delete-storage-v1-storage-class-with-http-info name body nil))
...
(defn delete-storage-v1-storage-class
  "
  delete a StorageClass"
  ([name body ] (delete-storage-v1-storage-class name body nil))
  ([name body optional-params]
   (:data (delete-storage-v1-storage-class-with-http-info name body optional-params))))
