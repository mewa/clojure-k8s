...
(defn delete-core-v1-namespace-with-http-info
  "
  delete a Namespace"
  ([name body ] (delete-core-v1-namespace-with-http-info name body nil))
...
(defn delete-core-v1-namespace
  "
  delete a Namespace"
  ([name body ] (delete-core-v1-namespace name body nil))
  ([name body optional-params]
   (:data (delete-core-v1-namespace-with-http-info name body optional-params))))

(defn delete-core-v1-namespaced-config-map-with-http-info
  "
  delete a ConfigMap"
  ([name namespace body ] (delete-core-v1-namespaced-config-map-with-http-info name namespace body nil))
...
(defn delete-core-v1-namespaced-config-map
  "
  delete a ConfigMap"
  ([name namespace body ] (delete-core-v1-namespaced-config-map name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-core-v1-namespaced-config-map-with-http-info name namespace body optional-params))))

(defn delete-core-v1-namespaced-endpoints-with-http-info
  "
  delete Endpoints"
  ([name namespace body ] (delete-core-v1-namespaced-endpoints-with-http-info name namespace body nil))
  ([name namespace body {:keys [pretty grace-period-seconds orphan-dependents propagation-policy ]}]
   (check-required-params name namespace body)
...
(defn delete-core-v1-namespaced-endpoints
  "
  delete Endpoints"
  ([name namespace body ] (delete-core-v1-namespaced-endpoints name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-core-v1-namespaced-endpoints-with-http-info name namespace body optional-params))))

(defn delete-core-v1-namespaced-event-with-http-info
  "
  delete an Event"
  ([name namespace body ] (delete-core-v1-namespaced-event-with-http-info name namespace body nil))
  ([name namespace body {:keys [pretty grace-period-seconds orphan-dependents propagation-policy ]}]
   (check-required-params name namespace body)
...
(defn delete-core-v1-namespaced-event
  "
  delete an Event"
  ([name namespace body ] (delete-core-v1-namespaced-event name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-core-v1-namespaced-event-with-http-info name namespace body optional-params))))

(defn delete-core-v1-namespaced-limit-range-with-http-info
  "
  delete a LimitRange"
  ([name namespace body ] (delete-core-v1-namespaced-limit-range-with-http-info name namespace body nil))
  ([name namespace body {:keys [pretty grace-period-seconds orphan-dependents propagation-policy ]}]
   (check-required-params name namespace body)
...
(defn delete-core-v1-namespaced-limit-range
  "
  delete a LimitRange"
  ([name namespace body ] (delete-core-v1-namespaced-limit-range name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-core-v1-namespaced-limit-range-with-http-info name namespace body optional-params))))

(defn delete-core-v1-namespaced-persistent-volume-claim-with-http-info
  "
  delete a PersistentVolumeClaim"
  ([name namespace body ] (delete-core-v1-namespaced-persistent-volume-claim-with-http-info name namespace body nil))
  ([name namespace body {:keys [pretty grace-period-seconds orphan-dependents propagation-policy ]}]
   (check-required-params name namespace body)
...
(defn delete-core-v1-namespaced-persistent-volume-claim
  "
  delete a PersistentVolumeClaim"
  ([name namespace body ] (delete-core-v1-namespaced-persistent-volume-claim name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-core-v1-namespaced-persistent-volume-claim-with-http-info name namespace body optional-params))))

(defn delete-core-v1-namespaced-pod-with-http-info
  "
  delete a Pod"
  ([name namespace body ] (delete-core-v1-namespaced-pod-with-http-info name namespace body nil))
  ([name namespace body {:keys [pretty grace-period-seconds orphan-dependents propagation-policy ]}]
   (check-required-params name namespace body)
...
(defn delete-core-v1-namespaced-pod
  "
  delete a Pod"
  ([name namespace body ] (delete-core-v1-namespaced-pod name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-core-v1-namespaced-pod-with-http-info name namespace body optional-params))))

(defn delete-core-v1-namespaced-pod-template-with-http-info
  "
  delete a PodTemplate"
  ([name namespace body ] (delete-core-v1-namespaced-pod-template-with-http-info name namespace body nil))
  ([name namespace body {:keys [pretty grace-period-seconds orphan-dependents propagation-policy ]}]
   (check-required-params name namespace body)
...
(defn delete-core-v1-namespaced-pod-template
  "
  delete a PodTemplate"
  ([name namespace body ] (delete-core-v1-namespaced-pod-template name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-core-v1-namespaced-pod-template-with-http-info name namespace body optional-params))))

(defn delete-core-v1-namespaced-replication-controller-with-http-info
  "
  delete a ReplicationController"
  ([name namespace body ] (delete-core-v1-namespaced-replication-controller-with-http-info name namespace body nil))
  ([name namespace body {:keys [pretty grace-period-seconds orphan-dependents propagation-policy ]}]
   (check-required-params name namespace body)
...
(defn delete-core-v1-namespaced-replication-controller
  "
  delete a ReplicationController"
  ([name namespace body ] (delete-core-v1-namespaced-replication-controller name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-core-v1-namespaced-replication-controller-with-http-info name namespace body optional-params))))

(defn delete-core-v1-namespaced-resource-quota-with-http-info
  "
  delete a ResourceQuota"
  ([name namespace body ] (delete-core-v1-namespaced-resource-quota-with-http-info name namespace body nil))
  ([name namespace body {:keys [pretty grace-period-seconds orphan-dependents propagation-policy ]}]
   (check-required-params name namespace body)
...
(defn delete-core-v1-namespaced-resource-quota
  "
  delete a ResourceQuota"
  ([name namespace body ] (delete-core-v1-namespaced-resource-quota name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-core-v1-namespaced-resource-quota-with-http-info name namespace body optional-params))))

(defn delete-core-v1-namespaced-secret-with-http-info
  "
  delete a Secret"
  ([name namespace body ] (delete-core-v1-namespaced-secret-with-http-info name namespace body nil))
  ([name namespace body {:keys [pretty grace-period-seconds orphan-dependents propagation-policy ]}]
   (check-required-params name namespace body)
...
(defn delete-core-v1-namespaced-secret
  "
  delete a Secret"
  ([name namespace body ] (delete-core-v1-namespaced-secret name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-core-v1-namespaced-secret-with-http-info name namespace body optional-params))))
...
(defn delete-core-v1-namespaced-service-account-with-http-info
  ...
  ([name namespace body ] (delete-core-v1-namespaced-service-account-with-http-info name namespace body nil))
  ([name namespace body {:keys [pretty grace-period-seconds orphan-dependents propagation-policy ]}]
   (check-required-params name namespace body)
...
(defn delete-core-v1-namespaced-service-account
  "
  delete a ServiceAccount"
  ([name namespace body ] (delete-core-v1-namespaced-service-account name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-core-v1-namespaced-service-account-with-http-info name namespace body optional-params))))

(defn delete-core-v1-node-with-http-info
  "
  delete a Node"
  ([name body ] (delete-core-v1-node-with-http-info name body nil))
  ([name body {:keys [pretty grace-period-seconds orphan-dependents propagation-policy ]}]
   (check-required-params name body)
...
(defn delete-core-v1-node
  "
  delete a Node"
  ([name body ] (delete-core-v1-node name body nil))
  ([name body optional-params]
   (:data (delete-core-v1-node-with-http-info name body optional-params))))

(defn delete-core-v1-persistent-volume-with-http-info
  "
  delete a PersistentVolume"
  ([name body ] (delete-core-v1-persistent-volume-with-http-info name body nil))
  ([name body {:keys [pretty grace-period-seconds orphan-dependents propagation-policy ]}]
   (check-required-params name body)
...
(defn delete-core-v1-persistent-volume
  "
  delete a PersistentVolume"
  ([name body ] (delete-core-v1-persistent-volume name body nil))
  ([name body optional-params]
   (:data (delete-core-v1-persistent-volume-with-http-info name body optional-params))))
