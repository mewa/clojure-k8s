...
(defn delete-networking-v1-namespaced-network-policy-with-http-info
  ...
  ([name namespace body ] (delete-networking-v1-namespaced-network-policy-with-http-info name namespace body nil))
...
(defn delete-networking-v1-namespaced-network-policy
  "
  delete a NetworkPolicy"
  ([name namespace body ] (delete-networking-v1-namespaced-network-policy name namespace body nil))
  ([name namespace body optional-params]
   (:data (delete-networking-v1-namespaced-network-policy-with-http-info name namespace body optional-params))))
